...
extern const uint8_t   sdp_hid_android_service_record[];
extern const uint8_t   sdp_hid_android_pnp_service_record[];
...
#elif (BT_HID_TYPE == 3)
     .service_record         = (uint8_t *)sdp_hid_android_service_record,
#else
    .service_record         = ...
#endif
};
...
#if (BT_HID_TYPE == 3)
    .service_record         = (uint8_t *)sdp_hid_android_pnp_service_record,
#else
