...
#define BT_SCO_SMIC_AI_EN               1                           //是否打开自研单麦AI降噪算法
#define BT_SCO_SMIC_AI_LEVEL		    xcfg_cb.bt_dnn_level        //降噪量：0~40级（建议范围，默认0级）

#define BT_SCO_AIAEC_DNN_EN             0                           //是否打开自研单麦ASM汇编优化AI降噪算法
 ...
 *****************************************************************************/
#define UDE_STORAGE_EN                  1                           //使能usb udisk
...
#define ANC_ALG_AI_WN_FF_EN             0           //自研单MIC(FF)AI风噪检测算法
