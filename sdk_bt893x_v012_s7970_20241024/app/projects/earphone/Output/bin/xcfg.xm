...
config(BIT, "AEC数字增益", "AEC频域数字增益(0~15DB), Step 1DB", AEC_DIG_GAIN, 4, 0, 15, 0, BT_AEC_EN);
config(BIT, "远端补偿", "远端信号的偏移值", AEC_FAR_OFFSET,  16, 0, 600, 301);
...
config(CHECK, "自研双麦AI降噪", "config.h打开BT_SCO_DMNS_EN或者BT_SCO_DMDNN_EN", BT_DMNS_EN, 0, BT_NR_EN);
...
config(LISTVAL, "左耳USER_DEF键短按", "选择左耳USER_DEF键短按的功能，若关闭TWS功能，则为立体声USER_DEF键功能", USER_DEF_KS_SEL,    BIT, 8, 11, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14)); #@lewis
config(LISTVAL, "左耳USER_DEF键长按", "选择左耳USER_DEF键长按的功能，若关闭TWS功能，则为立体声USER_DEF键功能", USER_DEF_KL_SEL,    BIT, 8, 2, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14)); #@lewis
config(LISTVAL, "左耳USER_DEF键双击", "选择左耳USER_DEF键双击的功能，若关闭TWS功能，则为立体声USER_DEF键功能", USER_DEF_KD_SEL,    BIT, 8, 1, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14)); #@lewis
config(LISTVAL, "左耳USER_DEF键三击", "选择左耳USER_DEF键三击的功能，若关闭TWS功能，则为立体声USER_DEF键功能", USER_DEF_KT_SEL, 	  BIT, 8, 0, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14)); #@lewis
config(LISTVAL, "左耳USER_DEF键四击", "选择左耳USER_DEF键四击的功能，若关闭TWS功能，则为立体声USER_DEF键功能", USER_DEF_KFOUR_SEL, BIT, 8, 0, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14)); #@lewis
config(LISTVAL, "左耳USER_DEF键五击", "选择左耳USER_DEF键五击的功能，若关闭TWS功能，则为立体声USER_DEF键功能", USER_DEF_KFIVE_SEL, BIT, 8, 0, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14)); #@lewis
config(CHECK, "USER_DEF键区分左右耳", "USER_DEF键区分左右耳的功能，关闭后，右耳USER_DEF键功能与左耳相同", USER_DEF_LR_EN, 0, BT_TWS_EN); #@lewis
config(LISTVAL, "右耳USER_DEF键短按", "选择右耳USER_DEF键短按的功能", USER_DEF_R_KS_SEL,    BIT, 8, 11, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14), USER_DEF_LR_EN); #@lewis
config(LISTVAL, "右耳USER_DEF键长按", "选择右耳USER_DEF键长按的功能", USER_DEF_R_KL_SEL,    BIT, 8, 2, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14), USER_DEF_LR_EN); #@lewis
config(LISTVAL, "右耳USER_DEF键双击", "选择右耳USER_DEF键双击的功能", USER_DEF_R_KD_SEL,    BIT, 8, 1, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14), USER_DEF_LR_EN); #@lewis
config(LISTVAL, "右耳USER_DEF键三击", "选择右耳USER_DEF键三击的功能", USER_DEF_R_KT_SEL, 	  BIT, 8, 0, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14), USER_DEF_LR_EN); #@lewis
config(LISTVAL, "右耳USER_DEF键四击", "选择右耳USER_DEF键四击的功能", USER_DEF_R_KFOUR_SEL, BIT, 8, 0, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14), USER_DEF_LR_EN); #@lewis
config(LISTVAL, "右耳USER_DEF键五击", "选择右耳USER_DEF键五击的功能", USER_DEF_R_KFIVE_SEL, BIT, 8, 0, 15, ("无", 0), ("回拨", 1), ("SIRI", 2), ("PREV", 3), ("NEXT", 4), ("VOL+", 5), ("VOL-", 6), ("MODE", 7), ("HID拍照", 8), ("IOS HOME", 9), ("中英文切换", 10), ("PLAY/PAUSE", 11), ("CBT_TEST", 12), ("低延时", 13), ("降噪控制", 14), USER_DEF_LR_EN); #@lewis
...
#config(CHECK, "USER_DEF键区分左右耳", "USER_DEF键区分左右耳的功能，配置中为左耳功能（例如左耳上一曲，则右耳为下一曲，音量加减同理）", USER_DEF_LR_EN, 0); #@lewis
