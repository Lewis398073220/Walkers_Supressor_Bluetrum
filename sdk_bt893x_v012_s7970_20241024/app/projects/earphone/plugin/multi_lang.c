...
//@lewis
        ...
        [RES_IDX_PAIRING    ] = {&RES_BUF_WAV(EN_PAIRING),      &RES_LEN_WAV(EN_PAIRING)},
        [RES_IDX_CONNECTED  ] = {&RES_BUF_WAV(EN_CONNECTED),    &RES_LEN_WAV(EN_CONNECTED)},
		[RES_IDX_DISCONNECT ] = {&RES_BUF_WAV(EN_DISCONNECT),   &RES_LEN_WAV(EN_DISCONNECT)},
